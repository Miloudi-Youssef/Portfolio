      ...
      <form onSubmit={handleSubmit} className="relative">
        ...
        >
            ...
            <div className="absolute inset-0 bg-primary-50 dark:bg-primary-900/30 border-2 border-dashed border-primary-500 rounded-lg flex items-center justify-center z-10">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-primary-700 dark:text-primary-300">
                  Drop ESG reports to upload, or drop documents to add to context
                </p>
              </div>
            </div>
          )}
          ...
          <textarea
            ...
            placeholder={isConnected ? "Ask about CSRD compliance, GHG emissions, or sustainability targets… (@ for reports, # for topics)" : "Server offline — analysis unavailable"}
