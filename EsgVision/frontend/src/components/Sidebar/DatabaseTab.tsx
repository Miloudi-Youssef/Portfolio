    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="bg-primary-50 dark:bg-primary-900/20 rounded-xl p-3 border border-primary-100 dark:border-primary-900/40">
          ...
          <div className="text-xs text-primary-600 dark:text-primary-400 mt-0.5 font-medium">Reports</div>
        </div>
        <div className="bg-secondary-100 dark:bg-secondary-700 rounded-xl p-3 border border-secondary-200 dark:border-secondary-600">
          <div className="text-2xl font-bold text-secondary-700 dark:text-secondary-200">
            {stats?.total_chunks || 0}
          </div>
          <div className="text-xs text-secondary-500 dark:text-secondary-400 mt-0.5 font-medium">Sections</div>
        </div>
        <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-3 border border-emerald-100 dark:border-emerald-900/40">
          <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-400">
            {stats?.total_entities || 0}
          </div>
          <div className="text-xs text-emerald-600 dark:text-emerald-400 mt-0.5 font-medium">ESG Entities</div>
        </div>
        <div className="bg-violet-50 dark:bg-violet-900/20 rounded-xl p-3 border border-violet-100 dark:border-violet-900/40">
          <div className="text-2xl font-bold text-violet-700 dark:text-violet-400">
            {stats?.total_relationships || 0}
          </div>
          <div className="text-xs text-violet-600 dark:text-violet-400 mt-0.5 font-medium">Connections</div>
        </div>
      </div>
          ...
          {!searchMode ? (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-medium text-secondary-900 dark:text-secondary-50">Knowledge Base</h3>
                <button
      ...
      {stats && stats.documents.length === 0 && (
        <div className="text-center text-secondary-600 dark:text-secondary-400 py-8">
          <p className="font-medium">No reports in knowledge base</p>
          <p className="text-xs mt-1">Upload ESG reports to get started</p>
        </div>
      )}
      </div>
    </div>
