...
export default function Sidebar({
  ...
  const tabs = [
    { id: 'history' as const, label: 'Sessions', icon: ClockIcon },
    { id: 'database' as const, label: 'Knowledge Base', icon: CircleStackIcon },
  ]
            ...
            <>
              ...
              <div className="p-5 border-b border-secondary-200 dark:border-secondary-700">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <div>
                    <h1 className="text-base font-bold text-secondary-900 dark:text-secondary-50 leading-tight">ESG Vision</h1>
                    <p className="text-xs text-primary-600 dark:text-primary-400 font-medium">Knowledge Graph Platform</p>
                  </div>
                </div>
                <p className="text-xs text-secondary-500 dark:text-secondary-500 mt-2 leading-relaxed">
                  AI-powered CSRD & ESG report intelligence
                </p>
              </div>
